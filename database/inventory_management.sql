...
--
-- Host: localhost
-- Generation Time: Feb 20, 2025 at 01:41 AM
...
(1, 'tepung', 'tepung buat untuk roati');
...
INSERT INTO `orders` (`order_id`, `supplier_id`, `user_id`, `status`, `order_date`) VALUES
(1, 1, 1, 'completed', '2025-02-19 23:33:08');
...
INSERT INTO `products` (`product_id`, `name`, `description`, `category_id`, `supplier_id`, `price`, `stock`, `created_at`) VALUES
(1, 'terigu', NULL, 1, 1, 20000.00, 100, '2025-02-19 23:28:49');
...
INSERT INTO `stock_movements` (`movement_id`, `product_id`, `transaction_id`, `previous_stock`, `new_stock`, `date`) VALUES
(1, 1, 1, 100, 196, '2025-02-19 23:38:32');
...
(1, 'azlan', '0812345678900', 'azlan@gmail.ocm', 'jl kesuksesan no 1');
...
INSERT INTO `transactions` (`transaction_id`, `product_id`, `user_id`, `type`, `quantity`, `total_price`, `date`) VALUES
(1, 1, 1, 'out', 2, 40000.00, '2025-02-19 23:36:44');
...
(1, 'bayu', 'bayukusumah@gmail.com', '1234567890', 'admin', '2025-02-13 00:43:50'),
(5, 'lina', 'lina@gmail.com', '1234567890', 'admin', '2025-02-19 23:07:53');
...
--
ALTER TABLE `inventory_alerts`
  ADD CONSTRAINT `inventory_alerts_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE;
...
ALTER TABLE `stock_movements`
  ...
  ADD CONSTRAINT `stock_movements_ibfk_2` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`transaction_id`) ON DELETE CASCADE;
